...
router.route("/managers").get(verifyToken,authorization('admin'),managerController.findAllManager)
router.route("/make-managers/:id").patch(verifyToken,authorization('admin'),adminController.makeAdmin)
