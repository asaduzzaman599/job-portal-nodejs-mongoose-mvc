...
router.route('/').get(jobController.findAllJob).post(verifyToken,authorization('manager'),jobController.createJob)
...
router.route('/:id').get(jobController.findOneJob).patch(verifyToken,authorization('manager'),jobController.updateJob)
